...
// import 'package:maqdis_connect/features/beranda/views/beranda_screen.dart';
...
//   void getDataUser() {
//     SharedPreferencesService.getDataUser().then((value) {
//       setState(() {
//         iduser = value.iduser;
//         roleid = value.role;
//         apikey = value.token;
...
//     try {
//       // Memuat role dari SharedPreferencesService.getRole()
...
//       setState(() {
//         isLoadingRole = false; // Hentikan loading jika ada error
//       });
//     }
//   }
